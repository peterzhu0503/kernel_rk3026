#ifdef	CONFIG_TOUCHSCREEN_GSL3670
#include	"rockchip_gslX670.c"
#elif defined(CONFIG_TOUCHSCREEN_GSL1680_NEW)
#include	"rockchip_gslX680_NEW.c"
#else
/*
...
#if defined(CONFIG_TOUCHSCREEN_GSL1680_7INCH_800x480_LEHENG)
#include "rockchip_gsl1680_7inch_800x480_LeHeng.h"
#elif defined(CONFIG_TOUCHSCREEN_GSL1680_7INCH_800x480_SHENGHEXIANG)
#include "rockchip_gsl1680_7inch_800x480_ShengHeXiang.h"
#elif defined(CONFIG_TOUCHSCREEN_GSL1680_7INCH_800x480_SHENGHEXIANG_QLT)
#include "rockchip_gsl1680_7inch_800x480_ShengHeXiang_QLT.h"
#elif defined(CONFIG_TOUCHSCREEN_GSL1680_7INCH_1024x600_SHENGHEXIANG)
#include "rockchip_gsl1680_7inch_1024x600_ShengHeXiang.h"
#elif defined(CONFIG_TOUCHSCREEN_GSL1680_7INCH_800x480_YOUCHU)
#include "rockchip_gsl1680_7inch_800x480_YouChu.h"
#elif defined(CONFIG_TOUCHSCREEN_GSL1680_7INCH_800x480_DEYI)
#include "rockchip_gsl1680_7inch_800x480_DeYi.h"
#elif defined(CONFIG_TOUCHSCREEN_GSL1680_7INCH_800x480_YOUCHU_YISENG)
...
#elif defined(CONFIG_TOUCHSCREEN_GSL1680_7INCH_1024x600_DEYI)
#include "rockchip_gsl1680_7inch_1024x600_DeYi.h"
#elif defined(CONFIG_TOUCHSCREEN_GSL1680_7INCH_1024x600_FEICHU)
#include "rockchip_gsl1680_7inch_1024x600_FeiChu.h"
#elif defined(CONFIG_TOUCHSCREEN_GSL1680_7INCH_1024x600_AOPUDUN)
#include "rockchip_gsl1680_7inch_1024x600_AoPuDun.h"

#elif defined(CONFIG_GSLX680_9INCH_800X480)
#include "rockchip_gslX680_9inch_800x480.h"
#elif defined(CONFIG_GSLX680_9INCH_800X480_TENGYAO)
#include "rockchip_gslX680_9inch_800x480_TengYao.h"
#elif defined(CONFIG_GSLX680_9INCH_1024X600)
#include "rockchip_gslX680_9inch_1024x600.h"
#elif defined(CONFIG_GSLX680_8INCH_800X600)
#include "rockchip_gslX680_8inch_800x600.h"
#elif defined(CONFIG_GSLX680_8INCH_1024X600)
...
static int check_chip(struct i2c_client *client)
{
	u8 read_buf = 0;
	int ret;
	ret = gsl_ts_read( client, 0xf0, &read_buf, sizeof(read_buf) );
			...
			const struct i2c_device_id *id)
{
	...
	//test ack liufeng@20130423 added
	rc = gsl_ts_read(client, 0xbc, read_buf, 4);
	if (rc < 0) {
