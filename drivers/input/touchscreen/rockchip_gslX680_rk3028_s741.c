...
#ifdef CONFIG_RK3028A_R70NG
#define IRQ_PORT			RK2928_PIN3_PC7
#define WAKE_PORT			RK2928_PIN3_PC3

#define ROTATE_X        1
#define ROTATE_Y        1
#define HAVE_TOUCH_KEY                                  //open touchkey for m15

#ifdef HAVE_TOUCH_KEY
#include "rockchip_gslX680_m15_touchkey.h"
#else
#include "rockchip_gslX680_m15_old.h"
#endif
#endif

#ifdef CONFIG_RK3026_R702W
#define IRQ_PORT			RK2928_PIN1_PB0
#include "rockchip_gslX680_s741.h"
#endif

#ifdef CONFIG_RK3026_S741
#define IRQ_PORT			RK2928_PIN1_PB0
#define WAKE_PORT			RK2928_PIN0_PD3
#include "rockchip_gslX680_s741_new.h"//#include "rockchip_gslX680_s741.h"
#endif

#ifdef CONFIG_RK3028A_S741
#define IRQ_PORT			RK2928_PIN3_PC7
#define WAKE_PORT			RK2928_PIN3_PC3
#include "rockchip_gslX680_s741_new.h"
#endif

#define CONFIG_RK3028A_R710E
#ifdef CONFIG_RK3028A_R710E
#define IRQ_PORT			RK2928_PIN3_PC7
#define WAKE_PORT			RK2928_PIN3_PC3
#include "rockchip_gslX680_s741.h"
#endif

#ifdef CONFIG_RK3028A_R70CC
#define IRQ_PORT			RK2928_PIN3_PC7
#define WAKE_PORT			RK2928_PIN3_PC3
#include "rockchip_gslX680_r70cc.h"
#endif

#ifdef CONFIG_RK3028A_R70KB
#define IRQ_PORT			RK2928_PIN3_PC7
#define WAKE_PORT			RK2928_PIN3_PC3
#include "rockchip_gslX680_r70kb.h"
#endif

#ifdef CONFIG_RK3026_S753
#define IRQ_PORT			RK2928_PIN1_PB0
#define WAKE_PORT			RK2928_PIN0_PD3
#include "rockchip_gslX680_s741.h"
#endif

#ifdef CONFIG_RK3028A_S753
#define IRQ_PORT			RK2928_PIN3_PC7
#define WAKE_PORT			RK2928_PIN3_PC3
#include "rockchip_gslX680_s741.h"
#endif

#ifdef CONFIG_RK3026_S750
#define IRQ_PORT			RK2928_PIN1_PB0
#define WAKE_PORT			RK2928_PIN0_PD3
#include "rockchip_gslX680_s741.h"
#endif

#ifdef CONFIG_RK3026_R70GB
#define IRQ_PORT			RK2928_PIN1_PB0
#define WAKE_PORT			RK2928_PIN0_PD3
#include "rockchip_gslX680_r70gb.h"
#endif

#ifdef CONFIG_RK3026_M755
#define IRQ_PORT			RK2928_PIN1_PB0
#define WAKE_PORT			RK2928_PIN0_PD3
#include "rockchip_gslX680_s741_new.h"
#endif
...
struct key_data gsl_key_data[MAX_KEY_NUM] = {
 	...
 	{KEY_BACK, 806, 846,148, 220},
        {KEY_HOME, 806, 846,244, 315},  
        {KEY_MENU,806, 846, 340, 410},
        {KEY_SEARCH,806, 846, 52, 125},
...
static u32 gsl_write_interface(struct i2c_client *client, const u8 reg, u8 *buf, u32 num)
{
	...
	xfer_msg[0].flags = client->flags & I2C_M_TEN;
	xfer_msg[0].buf = buf;
	xfer_msg[0].scl_rate = 300*1000; //RK3066 RK2926 I2C报错时打开这个
			...
			const struct i2c_device_id *id)
{
	...
	if(tp_sensor_flag)
	{
		printk("\ntp_sensor_flag = 1, other tp_sensor exsit already ,so stop probe!\n");
		return -1;
	}
	printk("GSLX680 Enter %s\n", __func__);
	...
	if(rc <0 )
	{
		printk( "gslx680 test i2c fail! maby the chip not exist!\n");
		gpio_free(IRQ_PORT);
#ifdef WAKE_PORT
		gpio_free(WAKE_PORT);
#endif
